...
Our primary goal is to ensure the protection and confidentiality of sensitive data stored by users on hiraku-ai.
...
For immediate concerns or detailed reports that meet our guidelines, please create an issue in our [issue tracker](/hiraku-ai/hiraku-ai/issues) or contact us on [Discord](https://discord.gg/5rJgQTnV4s).
