...
def version_callback(value: bool):
    if value:
        from hiraku.env import VERSION

        typer.echo(f"Hiraku AI version: {VERSION}")
        raise typer.Exit()
...
def serve(
    ...
    import hiraku.main  # we need set environment variables before importing main
    from hiraku.env import UVICORN_WORKERS  # Import the workers setting
