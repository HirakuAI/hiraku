...
from hiraku.env import SRC_LOG_LEVELS, PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS
from hiraku.models.functions import Functions
from hiraku.models.tools import Tools
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from hiraku.utils",
        "from apps": "from hiraku.apps",
        "from main": "from hiraku.main",
        "from config": "from hiraku.config",
    }
