...
from hiraku.models.chats import Chats
from hiraku.models.users import Users
from hiraku.socket.main import (
    get_event_call,
    get_event_emitter,
    get_active_status_by_user_id,
)
from hiraku.routers.tasks import (
    generate_queries,
    generate_title,
    generate_image_prompt,
    generate_chat_tags,
)
from hiraku.routers.retrieval import process_web_search, SearchForm
from hiraku.routers.images import image_generations, GenerateImageForm
from hiraku.routers.pipelines import (
    process_pipeline_inlet_filter,
    process_pipeline_outlet_filter,
)
from hiraku.routers.memories import query_memory, QueryMemoryForm

from hiraku.utils.webhook import post_webhook


from hiraku.models.users import UserModel
from hiraku.models.functions import Functions
from hiraku.models.models import Models

from hiraku.retrieval.utils import get_sources_from_files


from hiraku.utils.chat import generate_chat_completion
from hiraku.utils.task import (
    get_task_model_id,
    rag_template,
...
from hiraku.utils.tools import get_tools
from hiraku.utils.plugin import load_function_module_by_id
from hiraku.utils.filter import (
    get_sorted_filter_ids,
    process_filter_functions,
)
from hiraku.utils.code_interpreter import execute_code_jupyter

from hiraku.tasks import create_task
...
from hiraku.constants import TASKS
                    ...
                    if not get_active_status_by_user_id(user.id):
                        ...
                        if webhook_url:
                            post_webhook(
                                ...
                                webhook_url,
                                f"{title} - {request.app.state.config.HIRAKU_URL}/c/{metadata['chat_id']}\n\n{content}",
                                {
                                    "action": "chat",
                                    "message": content,
                                    "title": title,
                                    "url": f"{request.app.state.config.HIRAKU_URL}/c/{metadata['chat_id']}",
                                },
                            )
