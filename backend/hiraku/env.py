...
HIRAKU_DIR = Path(__file__).parent  # the path containing this file
print(HIRAKU_DIR)

BACKEND_DIR = HIRAKU_DIR.parent  # the path containing this file
...
try:
    ...
    changelog_content = (pkgutil.get_data("hiraku", "CHANGELOG.md") or b"").decode()
...
if FROM_INIT_PY:
    NEW_DATA_DIR = Path(os.getenv("DATA_DIR", HIRAKU_DIR / "data")).resolve()
    ...
    if DATA_DIR.exists() and DATA_DIR != NEW_DATA_DIR:
        ...
        shutil.make_archive(DATA_DIR.parent / "hiraku_data", "zip", DATA_DIR)

        # Remove the old data directory
        shutil.rmtree(DATA_DIR)

    DATA_DIR = Path(os.getenv("DATA_DIR", HIRAKU_DIR / "data"))

STATIC_DIR = Path(os.getenv("STATIC_DIR", HIRAKU_DIR / "static"))

FONTS_DIR = Path(os.getenv("FONTS_DIR", HIRAKU_DIR / "static" / "fonts"))

FRONTEND_BUILD_DIR = Path(os.getenv("FRONTEND_BUILD_DIR", BASE_DIR / "build")).resolve()

if FROM_INIT_PY:
    FRONTEND_BUILD_DIR = Path(
        os.getenv("FRONTEND_BUILD_DIR", HIRAKU_DIR / "frontend")
    ).resolve()
