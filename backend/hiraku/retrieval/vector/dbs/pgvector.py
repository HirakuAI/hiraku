...
from hiraku.retrieval.vector.main import (
    VectorDBBase,
    VectorItem,
    SearchResult,
    GetResult,
)
from hiraku.config import PGVECTOR_DB_URL, PGVECTOR_INITIALIZE_MAX_VECTOR_LENGTH
...
class PgvectorClient(VectorDBBase):
    def __init__(self) -> None:
        ...
        if not PGVECTOR_DB_URL:
            from hiraku.internal.db import Session
