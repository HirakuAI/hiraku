...
export const createNewFolder = async (token: string, name: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/folders/`, {
		method: 'POST',
		headers: {
...
export const getFolderById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/folders/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFolderNameById = async (token: string, id: string, name: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/folders/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFolderIsExpandedById = async (
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/folders/${id}/update/expanded`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFolderParentIdById = async (token: string, id: string, parentId?: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/folders/${id}/update/parent`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFolderItemsById = async (token: string, id: string, items: FolderItems) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/folders/${id}/update/items`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
