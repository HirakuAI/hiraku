...
export const createNewNote = async (token: string, note: NoteItem) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/notes/create`, {
		method: 'POST',
		headers: {
...
export const getNotes = async (token: string = '') => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/notes/`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getNoteById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/notes/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateNoteById = async (token: string, id: string, note: NoteItem) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/notes/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteNoteById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/notes/${id}/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
