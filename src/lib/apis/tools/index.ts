...
export const createNewTool = async (token: string, tool: object) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/create`, {
		method: 'POST',
		headers: {
...
export const loadToolByUrl = async (token: string = '', url: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/load/url`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getTools = async (token: string = '') => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getToolList = async (token: string = '') => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/list`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const exportTools = async (token: string = '') => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/export`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getToolById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/id/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateToolById = async (token: string, id: string, tool: object) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/id/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteToolById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/id/${id}/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getToolValvesById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/id/${id}/valves`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getToolValvesSpecById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/id/${id}/valves/spec`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateToolValvesById = async (token: string, id: string, valves: object) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/id/${id}/valves/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getUserValvesById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/id/${id}/valves/user`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getUserValvesSpecById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/id/${id}/valves/user/spec`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateUserValvesById = async (token: string, id: string, valves: object) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/tools/id/${id}/valves/user/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
