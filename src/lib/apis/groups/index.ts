...
export const createNewGroup = async (token: string, group: object) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/groups/create`, {
		method: 'POST',
		headers: {
...
export const getGroups = async (token: string = '') => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/groups/`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getGroupById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/groups/id/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateGroupById = async (token: string, id: string, group: object) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/groups/id/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteGroupById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/groups/id/${id}/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
