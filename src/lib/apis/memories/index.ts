...
export const getMemories = async (token: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/memories/`, {
		method: 'GET',
		headers: {
...
export const addNewMemory = async (token: string, content: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/memories/add`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateMemoryById = async (token: string, id: string, content: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/memories/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const queryMemory = async (token: string, content: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/memories/query`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteMemoryById = async (token: string, id: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/memories/${id}`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteMemoriesByUserId = async (token: string) => {
	...
	const res = await fetch(`${HIRAKU_API_BASE_URL}/memories/delete/user`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
