<script>
	...
	import { HIRAKU_NAME, config, user, showSidebar } from '$lib/stores';
						...
						<td class="px-3 py-1 font-medium text-gray-900 dark:text-white w-max">
							<div class="flex flex-row w-max">
								<img
									...
									src={user.profile_image_url.startsWith(HIRAKU_BASE_URL) ||
...
> 
> Hiraku AI is proudly open source and completely free, with no hidden limits — and we'd love to keep it that way. 🌱  
>
...
> 
> - 👉 **[Click here to learn more about enterprise licensing](https://bontal.net/404/enterprise)**
